    ...
    <div className="">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-16 sm:px-6 text-center gap-20">
        <div className="max-w-4xl space-y-8 relative">
          {/* Background gradient */}
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-blue-400 via-indigo-50 to-purple-300 dark:from-blue-950/20 dark:via-indigo-20 dark:to-purple-950/20 rounded-3xl blur-3xl scale-150 opacity-60"></div>
          <div className="max-w-4xl space-y-8 relative">
            ...
            <p className="text-xl text-muted-foreground max-x-2xl mx-auto leading-relaxed">
              The mordern messaging platform that combines lightning-fast chat
          ...
          <div className="w-full max-w-full">
            ...
            <div className="w-full flex items-center justify-center mb-16">
              <div className="flex-1 h-[2px] bg-gradient-to-r from-transparent via-border to-transparent"></div>
              <div className="px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
              ...
              <FeatureCard
                ...
                description="Optimized for speed and performance. Works seemlessly across all your devices with instant sync."
              />
            </div>
          </div>
          ...
          <div className="w-full max-w-4xl">
            <div className="rounded-2xl border bg-gradient-to-br from-primary/5 to-primary/10 p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of users who have already discovered a better way
                to communicate. Start your journey with Midzen Telegram today - it&apos;s
                completely free.
              </p>
      ...
      <footer className="border-t bg-muted/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            <div>
              <span className="text-xl font-bold tracking-light">Midzen Telegram</span>
